...
edu.uriship.math.match were created by
...
edu.uriship.math.grapher3d, put them into a package different from
the original. In this case too, please acknowledge this work.

Last modified: Novemeber 4, 2006

************************************************************************ */


import edu.uriship.math.parametric2d.CompiledObject;

class edu.uriship.math.parametric2d.MathParser {
...
function doEval(compiledExpression:Array,aVarVals:Array): Number {
