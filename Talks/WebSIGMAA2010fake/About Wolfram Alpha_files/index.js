...
/* ------------------------------------- */
  ...
  if ($.browser.safari) {
    $("#footer ul li").css({"padding-right": "21px","padding-left":"21px"});
    $("#footer ul li:last-child").css("padding-right", "0");
    $("#footer ul li:first-child").css("padding-left", "0");
...
function loadNewToAlpha() {
  ...
  $("#newToAlphaContainer").load("/newbie.html", function() {
    ...
    $("#try li a:not(#trymore)").click(function(e) {
      ...
      $("#popanchor").append('<img src="/sidebar.txt?type='+ 
	...
	/* Click tracking for New To Alpha */
           $("#popanchor").append('<img src="/sidebar.txt?type=more" style="display:none;"/>');
	...
	/* Click tracking for New To Alpha */
           $("#popanchor").append('<img src="/sidebar.txt?type=less" style="display:none;"/>');
        // Fixes a bug in IE where the bottom border won't render in the appropriate place
        if ($.browser.msie && ($.browser.version == "6.0" || $.browser.version == "7.0")) {
          $("#newbie .bot").css("top", "0").css("top", "auto");
        }
	...
	/* Click tracking for NewToAlpha */
        $("#popanchor").append('<img src="/sidebar.txt?type=remove" style="display:none;"/>');
      });
      $("#relatedlinks, #searchtheweb, #ads").css("top", "").css("top", "auto");
      $("#sidebar").css("left", "auto");
    });
 ...
 /* remove the "Are you new to W|A cookie */
  $("#new-to, #newto a").click(function(e){
	e.preventDefault();
         ...
         /* Click tracking for NewToAlpha */
           $("#popanchor").append('<img src="/sidebar.txt?type=add" style="display:none;"/>');
           loadNewToAlpha();
...
$("#cite").click(function(e){
  ...
  $("#citation").draggable( {handle: ".pdrag"} );
...
if ($.browser.opera) {
  $(window).load(function(){
    $("#holidaysale img").css({"margin":0,"padding":0,"float":"none"});
  });
}
